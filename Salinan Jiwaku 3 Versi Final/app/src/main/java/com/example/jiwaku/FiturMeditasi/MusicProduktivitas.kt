...
class MusicProduktivitas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_meditasi_music_produktivitas)
        ...
        // Konfigurasi Musik
        mediaPlayer = MediaPlayer.create(this, R.raw.musik_semangat)
